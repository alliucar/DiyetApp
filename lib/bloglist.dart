                ...
                child: Column(
                    children:[
                      InkWell(
                              ...
                              Row(
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text("Sınav Öncesi Beslenme",  style: TextStyle(
                                        fontSize: 12,
                                        fontWeight: FontWeight.bold,
                                      ...
                                      Container(
                                        ...
                                        child:Text("Her yıl olduğu gibi bir eğitim-öğretim yılının daha sonuna geldik. Lise öğrencilerinin heyecanla beklediği üniversite sınavı...",                     style: TextStyle(
                                          fontSize: 12,
                                          color: Color(0xff4D565B),
                                        ),),
                        ...
                        onTap: () {
                          Navigator.pushNamed(context, "/blogyazi1");
                        },
                      ),
                      InkWell(
                        child:   Row(
